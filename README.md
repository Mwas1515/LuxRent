...
1. Clone the respirotory
   git clone https://github.com/juan-ita/luxrent.git
   cd luxrent


2. **Open the project:**
Simply open the index.html file in your preferred browser to wiew to current build.
